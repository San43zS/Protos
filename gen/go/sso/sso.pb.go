...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               // email
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // password
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // app id of the app to login to
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // is admin
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x11, 0x73, 0x75, 0x6e, 0x73, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73,
